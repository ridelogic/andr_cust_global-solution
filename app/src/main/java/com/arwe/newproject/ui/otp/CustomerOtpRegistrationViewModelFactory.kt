...
class CustomerOtpRegistrationViewModelFactory(private val application: Application) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        return CustomerOtpRegistrationViewModel(application, repository, sessionManager) as T
    }
}
