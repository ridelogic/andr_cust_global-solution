...
class ProductSelectionViewModelFactory(private val application: Application) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        return ProductSelectionViewModel(application, repository) as T
    }
}
