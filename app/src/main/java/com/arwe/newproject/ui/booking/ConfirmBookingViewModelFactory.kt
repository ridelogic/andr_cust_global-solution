...
class ConfirmBookingViewModelFactory(private val application: Application) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        return ConfirmBookingViewModel(application, repository) as T
    }
}
